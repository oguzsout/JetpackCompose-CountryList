...
import com.oguzdogdu.jetpackcompose_countrylist.ui.theme.Purple500
    ...
    LazyColumn(
        ...
        filteredCountries = if (searchText.isEmpty()) {
            ...
            for (country in countries) {
                if (country.lowercase(java.util.Locale.getDefault())
                        .contains(searchText.lowercase(java.util.Locale.getDefault()))
                ) {
...
fun getListOfCountries(): ArrayList<String> {
    val isoCountryCodes = java.util.Locale.getISOCountries()
